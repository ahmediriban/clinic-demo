                    ...
                    <div className="p-6">
                      ...
                      <div className="flex gap-3">
                        <a
                          ...
                          className="flex-1 flex items-center justify-center gap-2 bg-[#1a7a3e] text-white text-sm font-semibold py-2.5 rounded-xl hover:bg-[#166534] transition-colors"
                        >
