        ...
        <div className="max-w-3xl">
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#1a7a3e] text-white font-bold px-7 py-3.5 rounded-full hover:bg-[#166534] transition-all shadow-lg hover:shadow-xl hover:scale-105 active:scale-95"
            >
